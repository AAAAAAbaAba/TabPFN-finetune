...
def get_cosine_schedule_with_warmup(optimizer, num_warmup_steps, num_training_steps, num_cycles=0.5, last_epoch=0):
...
def get_schedule_with_warmup(optimizer, num_warmup_steps, last_epoch=0):
